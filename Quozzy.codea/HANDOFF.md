...
> **Rename (done, user-facing only):** The app is branded **Vivaldiku** to users
> via `CFBundleDisplayName` and the in-game loading screen (formerly "Vivaldi-ku",
> before that "Kotoba"). Internals stay **Quozzy** deliberately — SCHEME, BUNDLE_ID,
...
## 21. HANDOFF STATE — 2026-09-07/08 (Handshake lockout fix, Vivaldiku rename, safe-area overlays, vs-button overhaul)
